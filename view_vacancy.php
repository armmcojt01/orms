			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="deadline" style="text-align: center">
						<?php
						// Check if deadline is set and not empty
						if (!empty($deadline)) {
							// Format the deadline into a more readable format (optional)
							echo "<strong>Deadline: </strong>" . date('F j, Y', strtotime($deadline));
						} else {
							echo "<strong>Deadline: </strong> Not specified";
						}
						?>
					</div>
				</div>
